...
* If the value is true, then we say that the observation **supports** _h_; if it is false, then the observation **falsifies** φ.
...
* Any proposition φ that follows from a theory Φ a **prediction** of Φ.

To falsify a theory Φ, it is sufficient to falsify any prediction. Any observation of a prediction φ of Φ supports Φ. We can conclude our enumeration as the following
...
Indeed the epistemological approach has become the predominant one in modern science.
