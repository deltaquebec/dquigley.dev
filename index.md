...
In my undergraduate at the [University of Wisconsin - Madison](https://www.wisc.edu/), I was involved in documentation, elicitation, and formatting stories in Menominee, both at the Menominee Reservation and in the lab with [Monica Macaulay](https://monicamacaulay.com/). I worked with [J. Mark Kenoyer](https://www.anthropology.wisc.edu/staff/kenoyer-j-mark/) on the Indus Valley Script, in which I studied writing as evident on pottery sherds, deomonstrating different sign frequencies relative to other written artifacts. In the physics department, I worked with the late Stephan Westerhoff on the [HAWC](https://www.hawc-observatory.org/) experiment, a part of [WIPAC](https://wipac.wisc.edu/), in which I worked on various hardware projects, contributed to IceCube-Gen2, and resolved discrepencies in gamma-ray observations across [HAWC](https://www.hawc-observatory.org/), [MAGIC](https://www.iac.es/en/observatorios-de-canarias/telescopes-and-experiments/magic-telescopes), [VERITAS](https://veritas.sao.arizona.edu/), 
and [H.E.S.S.](https://hess-experiment.eu/) observatories.
